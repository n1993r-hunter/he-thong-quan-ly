...
<head>
  ...
  <title>Zero-Sum Coin Exchange | Chi tiết nhóm</title>
...
<script>
  ...
  <script>const groupIdFromBackend = new URLSearchParams(location.search).get("id"); if(groupIdFromBackend && !new URLSearchParams(location.search).get("projectId")){ localStorage.setItem("zc_current_project_id", groupIdFromBackend); }</script>
